$(function() {
  $('#about-query').click(function(){
    $('#about-query a').css('color','dimgray');
  ...
  $('#servise-query').click(function(){
    $('#servise-query a').css('color','dimgray');
    $('#about-query a, #works-query a, #contact-query a').css('color','black');
  });
